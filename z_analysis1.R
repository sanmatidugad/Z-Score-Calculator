...
normalized_input = read.table(normalized_data, row.names = 1)
...
main = function(normalized_data, states_input, gene_counts, actionable_data, i){
  ...
  normalized_input.2 = normalized_input.1[, c("SYMBOL", i, "Normalized_Per_Million","Normal_Mean", "Normal_Median", "Normal_SD", "Z_score", "Foldchange", "Gene_State", "Potential_FP_or_FN")]    #selecting columns for final output
